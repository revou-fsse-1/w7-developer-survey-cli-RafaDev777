...
const questions = [
    ...
    },
    {
        type: "input",
        name: "email",
        message: (answer) => `Hello ${answer.firstName}, what is your email address?`,
    ...
    },
    {
        ...
        when: checkExp,
        validate: (input) => input.length > 0 ? true : "You have to choose at least one",
    },
    {
        type: "number",
        name: "salary",
...
inquirer
    ...
    .catch((error) => {
    console.log(error.isTtyError ? "your console environtment is not supported" : error);
});
